...
public class References {
    ...
    public static final String CLIENT_PROXY_CLASS = "com.github.txuritan.txcore.proxy.ClientProxy";
    public static final String COMMON_PROXY_CLASS = "com.github.txuritan.txcore.proxy.CommonProxy";
